 ...
 */
final class Version20220504083225 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD projetgestionnaire_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D64982D27837 FOREIGN KEY (projetgestionnaire_id) REFERENCES projet (id)');
        $this->addSql('CREATE INDEX IDX_8D93D64982D27837 ON user (projetgestionnaire_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_8D93D64982D27837 ON `user`');
        $this->addSql('ALTER TABLE `user` DROP projetgestionnaire_id');
    }
}
